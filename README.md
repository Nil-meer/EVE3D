...
2. Run EVE3D.py and enter: a) gene as named on EVE website, b) cut-offs for benign and c) pathogenic provided by EVE **multiplied by 100**, d) object name of your protein in PyMOL.
